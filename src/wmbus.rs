    ...
    O: OutputPin, SPI: SpiBus<u8>, M: BusyPin
{
    ...
    pub async fn set_wmbus_packet(&mut self, mode: WmbusMode, rx_bw: RxBw, pkt_format_tx: WmbusFormat, addr_filt_en: bool, pld_len: u8, pbl_len_tx: u16, pbl_len_detect: Option<u8>) -> Result<(), Lr2021Error> {
